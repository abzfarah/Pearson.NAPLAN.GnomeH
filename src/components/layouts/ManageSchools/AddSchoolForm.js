                ...
                <form onSubmit={handleSubmit((model) => { this.submitForm(model) })}>
                    <Box direction="row" className="boxRow">
                        ...
                        <Box className="sd_boxRight sd_editBgColor" align="start" pad="small" colorIndex="light-2">
                            ...
                            <Field name="dsPhone" type="text" component={TextField} floatingLabelText="Phone" />
                            <Field name="dsEmail" type="text" component={TextField} floatingLabelText="Email" />
                            <Field name="dsFax" type="text" component={TextField} floatingLabelText="Fax" />
                        </Box>
                    </Box>
