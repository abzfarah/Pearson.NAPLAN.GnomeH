          ...
          <form onSubmit={handleSubmit(this.handleFormSubmit.bind(this))}>
            <Box>
              ...
              <Paragraph>
                ...
                after the test and may be subject to audit by the VCAA.
              </Paragraph>
            </Box>
            ...
            <Box direction="row" className="boxRow">
              <Box className="sd_boxLeft sd_editBgColor" align="start" pad="small" colorIndex="light-2">
                ...
                <Box direction="row">
                  <Box className="declaration" >
                    <Field name="reviewed" ref="reviewed" component={Checkbox}
                      label="Details have been reviewed and are correct." />
                  </Box>
                </Box>
              </Box>
              ...
              <Box className="sd_boxLeft sd_editBgColor" align="start" pad="small" colorIndex="light-2">
                ...
                <Paragraph>
                  ...
                  the data provided by each school, or supplied by their jurisdictional authority. For schools who
                  wish to receive their test materials in another order, please briefly describe your request below.
                  If you do not require a special test packing arrangement no action needs to be taken.
                </Paragraph>

                <Box direction="row">
                  <Field name="requestPacking" ref="requestPacking" component={Checkbox}
                    label="I request a custom packing order for the NAPLAN tests. Details of this request are
                    provided below (e.g. Year 7 are to be packed aphabetically only and not by home group)." />
                </Box>
