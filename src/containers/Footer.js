  ...
  render () {
    ...
    return (
      <Footer size='small' appCentered={true} colorIndex='light-1'
        ...
        <Box  direction="row"  className="footerContainer"  wrap={true}>

        <Columns className="logo_1" className="flexy1" >
        ...
        <Box direction="column" className="colopon" className="flexy3" >
        <div className="colophon">
            <div className="column">
            <div className="social">
              <div className="twitter">
                <iframe  scrolling="no" src="//platform.twitter.com/widgets/follow_button.html?screen_name=pearson" className="twitter"></iframe>
              </div>
